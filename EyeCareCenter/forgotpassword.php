    ...
    <div id="templatemo_main">
   		<div id="sidebar" class="float_l">
       	  <div class="sidebar_box"><span class="bottom"></span>
           	<h3>New Users</h3>
            <a href="register.php"><img src="images/register.png" width="238" height="225" /></a> </div>
   		</div>
	...
	if(document.login.cont_no.value.length<5 || document.login.cont_no.value.length>11 )
  	{
        ...
        <form id="login" name="login" method="post" action="changepassword.php" onSubmit="return validation()">
          <p>&nbsp;<?php echo $msg; ?> Please enter your Email ID and your Contact number to change the password.</p>
      
             <table width="428" border="0">
              <tr>
                <td width="119" height="32"><label for="pat_id">Email ID</label></td>
                <td width="299"><input name="email_id" type="text" id="email_id" size="35" /></td>
              </tr>
              <tr>
                <td height="31">Contact Number</td>
