...
if(isset($_POST["login"]))
{
		...
		{   $sql="SELECT * FROM admin WHERE login_id='$_POST[login_id]' AND password='$_POST[password]'";
			...
			{
				$msg = "<font color ='red'>Invalid Login ID and Password";
			}
		}
...
?>
    ...
    <div id="templatemo_main">
   		<div id="sidebar" class="float_l">
       	  <img src="images/adminlogin.jpg" width="290" height="350" />
   		</div>
