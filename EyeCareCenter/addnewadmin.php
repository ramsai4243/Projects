...
if (!$res)
  ...
  {
 $rcsucc = "<b><font  color='#009900' >Admin Record Added Successfully.</b>";
  }
...
{ 
	$res = mysqli_query($con,"DELETE FROM admin where admin_id=$_GET[adminid]");
	if($res)
	{
		$rcsucc = "<b><font color='#009900'>Admin Record Deleted Successfully.</font></b>";
...
//	    return false
  ...
  echo "<td><a href='updateadmin.php?adminid=$row[admin_id]'>Update</a> | <a href='addnewadmin.php?adminid=$row[admin_id]&act=delete'>Delete</a></a></td>";
  echo "</tr>";
  }
?>
