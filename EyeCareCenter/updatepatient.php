...
if(isset($_POST['submit']))
{
	...
	$sql= "UPDATE  patient SET  pat_name =  '$_POST[name]', dob = '$dob',email_id = '$_POST[emailid]', contact= '$_POST[contact]',address='$_POST[address]' WHERE  pat_id ='$_POST[patid]';";
	//echo $sql;
	$res = mysqli_query($con,$sql);
	if($res)
	{
		$msg = "<b><font color='#009900'>Your Record Updated Successfully.</font></b>";
	}
	else
	{
	...
	else if(em.length<8)
	{
		...
		else if(type_end.toUpperCase()<"A" || type_end.toUpperCase()>"Z")
		{
          ...
          <form name="form1" id="form1" method="post" action="" onsubmit="return validation()"  >
            ...
            <tr>
                <td width="127">Patient's Name:</td>
              ...
              <tr>
                <td><label for="contact" class="left" >Contact Number:</label>
                <br /></td>
                <td><p>
