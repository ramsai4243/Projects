...
<select name="group" id="group">
  ...
  echo "<td>" . $row['mobile'] . "</td>";
    echo "<td><img src='upload/$row[image]' width='30' height='30'></td>";
  echo "<td><a href='updatedoctor.php?docid=$row[doc_id]'>Edit</a> / <a href='adddoctors.php?docid=$row[doc_id]&act=delete'>Delete</a></a></td>";
  echo "</tr>";
  }
