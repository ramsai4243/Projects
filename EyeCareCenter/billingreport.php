...
<table width="639" border="1">
  <tr>
    <th colspan="3" scope="row"><p>ADVANCED OPTICALS - EYE CARE CENTER - ALBANY, NY</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p></th>
  </tr>
  <tr>
  ...
  <tr>
    <th colspan="2" scope="row">The Details</th>
...
{
	//$respr=mysqli_query("SELECT * from products where prod_id='$retest[3]'");
...
?>
 <tr>
    <th colspan="2" scope="row">The Total Balance</th>
