...
{
	$res=mysqli_query($con, "UPDATE  admin SET  branch_id =  '$_POST[bname]',admin_name =  '$_POST[aname]',login_id =  '$_POST[loginid]',email_id =  '$_POST[emailid]' WHERE  admin_id ='$_GET[adminid]'");
	if($res)
	{
		$resvar = "<b><font color='#009900'>Admin Record Updated Successfully.</font></b>";
	}
	else
	{
