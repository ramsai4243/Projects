...
VALUES('$pname','$emailid','$password','$gender','$contact','$dt');";
//echo $sql;
...
// if($res)
 //{
 $rcsucc = "<font color='#E9967A' size='3' >Patient registered successfully.";
 //}
          ...
          <form id="reg" name="reg" method="post" action="" onsubmit="return validation()">
            ...
            <table width="478" border="0">
              ...
              <tr>
                ...
                <td><input class="right" name="password" type="password" id="password" size="50" /></td>
              </tr>
              <tr>
                <td height="43">Confirm Password:</td>
                <td><input class="right" name="cpassword" type="password" id="cpassword" size="50" /></td>
              </tr>
              <tr>
                <td height="43">Contact:</td>
                <td><input class="right" name="contact" type="text" id="contact" size="50" /></td>
              </tr>
              <tr>
