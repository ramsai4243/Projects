...
{
mysqli_query($con, "UPDATE patient SET password='$_POST[password]' WHERE email_id='$_POST[email_id]' and contact = '$_POST[cont_no]' ");
	if(mysqli_affected_rows() == 1)
	{
		$passwordupdate= 1;
	}
//$result1 = mysqli_query("SELECT * FROM patient WHERE pat_id='$_POST[pat_id]' AND password='$_POST[cont_no]'");
...
function validation()
{
	...
	{
		echo "<font color='#00FF00' size='3'><center>Password updated successfully..</center>";	
	...
	else
	{
		...
		{
		echo "<font color='#FF0000' size='3'><center>Customer ID or contact number not exist in database</center>";
		}
		else
		{
